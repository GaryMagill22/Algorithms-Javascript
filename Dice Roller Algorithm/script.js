...
// LEVEL 2 Level 2: Add another parameter for the number of die to roll and return each of the rolls performed as an array. //
...
var playerRoll = d6(3, 2);
console.log("The player rolled: " + playerRoll);
//  LEVEL 2 Level 2: Add another parameter for the number of die to roll and return each of the rolls performed as an array. //


//  LEVEL 3 Level 3:Include another parameter that represents a "Dice Check" and the dice roll must meet or exceed that Dice Check value. //
...
console.log(getRandomAnswer(lifesAnswers, 3));
